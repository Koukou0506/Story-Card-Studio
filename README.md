...
> 📷 **截图待补：应用首页全景**  
> 内容建议：侧边导航、项目概览、最近工作、进度和健康提示。  
> 建议路径：`docs/images/readme/project-home.webp`；建议尺寸：1600 × 900。
...
> 📷 **截图待补：下载、启动与首次打开**  
> 内容建议：Release 下载项、启动窗口和浏览器首页。  
> 建议路径：`docs/images/readme/quick-start.webp`。
...
> 📷 **截图待补：角色卡编辑器**  
> 内容建议：角色列表、编辑表单、质量检查与导出。  
> 建议路径：`docs/images/readme/character-card.webp`。
